...
turtles-own [energia]
experts-own [xp greens yellows count-down]
...
to Mover_experts
  ...
  [
    ...
    ;Abrigos
    if [pcolor] of patch-here = blue and count-down >= 1 [Stay]

    (ifelse[pcolor] of patch-here = blue and count-down >= 1
      [Stay]

      [pcolor] of patch-ahead 1 = blue
    ...
    (ifelse any? basics-on patch-ahead 1
      [let basico one-of basics-on patch-ahead 1 set energia energia + [energia] of basico ask basico[die]]

      any? basics-on patch-left-and-ahead 90 1
      [let basico one-of basics-on patch-left-and-ahead 90 1 set energia energia + [energia] of basico ask basico[die]]

      any? basics-on patch-right-and-ahead 90 1
      [let basico one-of basics-on patch-right-and-ahead 90 1 set energia energia + [energia] of basico ask basico[die]]
    )
